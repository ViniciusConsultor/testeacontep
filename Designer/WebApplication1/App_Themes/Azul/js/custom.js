$(document).ready(function () {
    ...
    /* Personalizadas por Francisco Rodrigues (Begin) */
    $("#sidebar").css('height', $('#main-wrapper').height());

    $(".btnAvancar")
            .addClass("btn ui-state-default ui-corner-all")
			.prepend('<span class="ui-icon ui-icon-circle-arrow-e"></span>')
			.end();
    $(".btnVoltar")
            .addClass("btn ui-state-default ui-corner-all")
    ...
    $(".btnAtualizar")
            .addClass("btn ui-state-default ui-corner-all")
			.prepend('<span class="ui-icon ui-icon-arrowrefresh-1-e"></span>')
			.end();
    $(".btnRelacionar")
            .addClass("btn ui-state-default ui-corner-all")
			.prepend('<span class="ui-icon ui-icon-link"></span>')
			.end();
    $(".btnLocalizar")
            .addClass("btn ui-state-default ui-corner-all")
			.prepend('<span class="ui-icon ui-icon-search"></span>')
			.end();
    $(".btnNovo")
            .addClass("btn ui-state-default ui-corner-all")
    ...
    $(".btnInfo")
			...
			.end();
    /* Personalizadas por Francisco Rodrigues (End) */
