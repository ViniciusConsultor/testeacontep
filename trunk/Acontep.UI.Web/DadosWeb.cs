...
namespace Acontep.UI.Web
{
    ...
    public static class DadosWeb
    {
        ...
        /// </summary>
        /// <param name="AcontepException"></param>
        public static void AtribuirMensagem(AcontepException AcontepException)
        {
            AtribuirMensagem(AcontepException.Message, MensagemWeb.Tipo.Erro);
        }
    }
}
